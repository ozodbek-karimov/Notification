...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.channelNotificationButton.setOnClickListener {
    ...
    private fun downloadNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val pendingIntent =
                PendingIntent.getBroadcast(requireContext(), 0, notificationIntent, PendingIntent.FLAG_IMMUTABLE)
    ...
    private fun setupAlarmAndSendNotification() {
        ...
        val notificationIntent = Intent(requireContext(), NotificationReceiver::class.java)
        val pendingIntent = PendingIntent.getBroadcast(requireContext(), 0, notificationIntent, PendingIntent.FLAG_IMMUTABLE)
